...
<tr>
  <td colspan="4"></td>
  <td><button onclick="calcu_idk()">Calculate</button></td>
  <td>Total: </td>
  <td><input name="" id="UMID_MI_FS_Final" disabled type="text"></td>
</tr>
</table>
...
yahvar_7.addEventListener("change", () =>{
 if (yahvar_7.value.toLowerCase() === "none")
 {
  yahvar_8.value = 0;
 }
 else if(yahvar_7.value.toLowerCase() === "utility")
 {
  yahvar_8.value = 10;
 }
 else if(yahvar_7.value.toLowerCase() === "industrial"){
  yahvar_8.value = 5;  }});

function calcu_idk()
{
  document.getElementById('UMID_MI_FS_Final').value = parseInt(yahvar_8.value)+parseInt(yahvar_6.value)+parseInt(yahvar_4.value)+parseInt(yahvar_2.value)
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
